...
#define SHMEM_CTX_TYPE_ATOMIC_COMPARE_SWAP_NBI(type_name, type, prefix)                  \
    type prefix##_ctx##type_name##_atomic_compare_swap_nbi(shmem_ctx_t ctx, type *fetch, type *target, type cond, type value, int pe) \
    {                                                                                    \
        type out_value;                                                                  \
...
#define SHMEM_TYPE_ATOMIC_COMPARE_SWAP_NBI(type_name, type, prefix)                      \
    type prefix##type_name##_atomic_compare_swap_nbi(type *fetch, type *target, type cond, type value, int pe) \
    {                                                                                    \
        type out_value;                                                                  \

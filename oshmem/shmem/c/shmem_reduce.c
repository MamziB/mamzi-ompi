 ...
 *
 * 
 * TODO based on Table 11, add short, int, long, and long long to and/xor/or 
 *
 *
 */
...
SHMEM_TYPE_TEAM_REDUCE_OP(sum, _complexd, complex double, OSHMEM_OP_SUM, SHMEM_COMPLEXD)
SHMEM_TYPE_TEAM_REDUCE_OP(sum, _complexf, complex float, OSHMEM_OP_SUM, SHMEM_COMPLEXF)
...
SHMEM_TYPE_TEAM_REDUCE_OP(prod, _complexd, complex double, OSHMEM_OP_PROD, SHMEM_COMPLEXD)
SHMEM_TYPE_TEAM_REDUCE_OP(prod, _complexf, complex float, OSHMEM_OP_PROD, SHMEM_COMPLEXF)
